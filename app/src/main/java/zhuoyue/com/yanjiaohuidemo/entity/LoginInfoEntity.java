 ...
 */
 ...
 public class LoginInfoEntity {
    ...
    public String getLottery_mobile() {
        return lottery_mobile;
    }

    public void setLottery_mobile(String lottery_mobile) {
        this.lottery_mobile = lottery_mobile;
    }

    public String getLottery_verify() {
        return lottery_verify;
    }

    public void setLottery_verify(String lottery_verify) {
        this.lottery_verify = lottery_verify;
    }
    ...
    public void setQqv2_id(String qqv2_id) {
        this.qqv2_id = qqv2_id;
    }
