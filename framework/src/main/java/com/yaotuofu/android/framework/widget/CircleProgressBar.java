...
public class CircleProgressBar extends View {
    ...
    private int processBackgroundColor = Color.WHITE;
    private RectF rectF;
    ...
    public int getProcessBackgroundColor() {
        return processBackgroundColor;
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            processBackgroundColor = typedArray.getInt(R.styleable.CircleProgressBar_progressbarBackgroundColor, processBackgroundColor);
        } finally {
            typedArray.recycle();
        }

        backgroundPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        backgroundPaint.setColor(processBackgroundColor);
