...
public class DateUtils {
    ...
    public static long[] calculateDifference(long differentMilliSeconds) {
        ...
        L.d(String.format("different: %d ms, %d days, %d hours, %d minutes, %d seconds",
    ...
    public static String getDValue(String dataStr){
    ...
    public static String getDValue(String starttime,String endtime){
