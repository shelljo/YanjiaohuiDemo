...
public class PhotoViewAttacher implements IPhotoView, View.OnTouchListener,
    ...
    public ImageView getImageView() {
        ...
        if (null == imageView) {
            cleanup();
            L.i("\"ImageView no longer exists. You should not use this PhotoViewAttacher any more.");
    ...
    public void onDrag(float dx, float dy) {
        ...
        if (DEBUG) {
            L.d( String.format("onDrag: dx: %.2f. dy: %.2f", dx, dy));
        }
    ...
    public void onFling(float startX, float startY, float velocityX,
                        float velocityY) {
        if (DEBUG) {
            L.d("\"onFling. sX: \" + startX + \" sY: \" + startY + \" Vx: \"\n" +
