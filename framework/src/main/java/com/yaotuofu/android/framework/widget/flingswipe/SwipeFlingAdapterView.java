package com.yaotuofu.android.framework.widget.flingswipe;
...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
    ...
    private boolean mNeedNextLayout = false;
    ...
    public static int LAST_OBJECT_IN_STACK = 0;
    ...
    private float positionF = 0f;

    public int getMAX_VISIBLE() {
        return MAX_VISIBLE;
    }

    public int getMIN_ADAPTER_STACK() {
        return MIN_ADAPTER_STACK;
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        mInLayout = true;
        L.d("mVideoList mNeedNextList=" + mNeedNextLayout);
            ...
            if (mActiveCard != null && topCard != null && topCard == mActiveCard) {
                if (this.flingCardListener.isTouching()) {
                    ...
                    if (this.mLastTouchPoint == null || !this.mLastTouchPoint.equals(lastPoint)) {
                        ...
                        mNeedNextLayout = false;// 这里重绘了就不在下面重复绘制
                    }
                }
                /** 让后面的页重绘 ***/
                if (mNeedNextLayout) {
                    mNeedNextLayout = false;
                    L.d("mVideoList 我在重绘后面的页面");
                    layoutChildren(1, adapterCount);
                }
                /***********/
            } else {
    ...
    private void setTopView() {
        if (getChildCount() > 0) {
            ...
            if (mActiveCard != null) {
                ...
                /** 确保设置成功 */
                flingCardListener.setEnableSwipe(mEnableSwipe);
    ...
    public void setNeedNextLayout(boolean needNextLayout) {
        this.mNeedNextLayout = needNextLayout;
    }
...
//        void onAdapterCountEqualToOne(int itemsInAdapter);
