...
public abstract class XRequest<T> implements Comparable<XRequest<T>> {
    ...
    private XResponse.ErrorListener mErrorListener;
     ...
     */
    @Deprecated
    public XRequest(String url, XResponse.ErrorListener listener) {
     ...
     */
    public XRequest(int method, String url, XResponse.ErrorListener listener) {
        mMethod = method;
        mUrl = url;
     ...
     */
    public XRequest<?> setTag(Object tag) {
        mTag = tag;
        return this;
    }
     ...
     */
    public XResponse.ErrorListener getErrorListener() {
     ...
     * @return This Request object to allow for chaining.
     */
    public XRequest<?> setRetryPolicy(RetryPolicy retryPolicy) {
     ...
     * @return This Request object to allow for chaining.
     */
    public XRequest<?> setRequestQueue(XRequestQueue requestQueue) {
     ...
     * @return This Request object to allow for chaining.
     */
    public final XRequest<?> setSequence(int sequence) {
        mSequence = sequence;
        return this;
    }
     ...
     * @return This Request object to allow for chaining.
     */
    public XRequest<?> setCacheEntry(Cache.Entry entry) {
        mCacheEntry = entry;
        return this;
    }
...
//    }
     ...
     * @return This Request object to allow for chaining.
     */
    public final XRequest<?> setShouldCache(boolean shouldCache) {
     ...
     */
    abstract protected XResponse<T> parseNetworkResponse(NetworkResponse response);
     ...
     */
    protected Throwable parseNetworkError(Throwable volleyError) {
        return volleyError;
    }
     ...
     */
    @Override
    public int compareTo(XRequest<T> other) {
