...
import com.yaotuofu.android.framework.cache.bigcache.other.bitmap.ImageScaleType;
...
import com.yaotuofu.android.framework.cache.bigcache.other.bitmap.ImageSizeUtils;
...
public class BitmapReadFromDisk implements ReadFromDisk<Bitmap> {
	...
	private ExifInfo defineExifOrientation(String filePath) {
		...
		try {
			...
			L.e("e" + "Can't read EXIF tags from file [%s]", filePath);
		}
